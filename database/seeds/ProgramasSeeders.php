...
class ProgramasSeeders extends Seeder
{
    ...
    public function run()
    {
        DB::table('programas')->insert(['id' => 1,
                                        'snies' => 91000,
                                        ...
                                        'id_facultad' => 1,
                                        'id_tipo_programa' => 1]);
        DB::table('programas')->insert(['id' => 2,
                                        'snies' => 91301,
                                        ...
                                        'id_facultad' => 1,
                                        'id_tipo_programa' => 1]);
        DB::table('programas')->insert(['id' => 3,
                                        'snies' => 105521,
                                        ...
                                        'id_facultad' => 1,
                                        'id_tipo_programa' => 1]);
        DB::table('programas')->insert(['id' => 4,
                                        'snies' => 12198,
                                        ...
                                        'id_facultad' => 1,
                                        'id_tipo_programa' => 2]);
        DB::table('programas')->insert(['id' => 5,
                                        'snies' => 3551,
                                        ...
                                        'id_facultad' => 1,
                                        'id_tipo_programa' => 2]);
        DB::table('programas')->insert(['id' => 6,
                                        'snies' => 103342,
                                        ...
                                        'id_facultad' => 1,
                                        'id_tipo_programa' => 2]);
        DB::table('programas')->insert(['id' => 7,
                                        'snies' => 102910,
                                        ...
                                        'id_facultad' => 1,
                                        'id_tipo_programa' => 2]);
        DB::table('programas')->insert(['id' => 8,
                                        'snies' => 54538,
                                        ...
                                        'id_facultad' => 1,
                                        'id_tipo_programa' => 2]);
        DB::table('programas')->insert(['id' => 9,
                                        'snies' => 104199,
