...
function multiselect_docente() {
  $('.filter_docente').multiselect({
    ...
    templates: {
      ul: '<ul class="multiselect-container dropdown-menu width-120 docente"></ul>'
    },
    onChange: function () {
      var _onChange = _asyncToGenerator(
      /*#__PURE__*/
      _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee(option, checked, select) {
...
function multiselect_asignatura() {
  $('.filter_asignatura').multiselect({
    ...
    templates: {
      ul: '<ul class="multiselect-container dropdown-menu width-120 asignatura"></ul>'
    }
  });
}
        ...
        switch (_context2.prev = _context2.next) {
          case 0:
            if ($('#content-docente').children('span').length != 0) {
              $('#content-docente').children('span').remove();
              $('#content-docente').append('<select name="docente" id="docente" class="form-control filter_docente docente">' + '<option value="">Seleccione el docente</option>' + '</select>');
            }
              ...
              success: function success(data) {
                if (data.length != 0) {
                  data.forEach(function (element) {
                    $('#docente').append('<option value="' + element.id_docente + '">' + element.nombres + ' ' + element.apellidos + '</option>');
                  });
                }
              }
            });
...
function listAsignaturas(_x4) {
  return _listAsignaturas.apply(this, arguments);
}

function _listAsignaturas() {
  _listAsignaturas = _asyncToGenerator(
  /*#__PURE__*/
  _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee4(id_docente) {
          ...
          case 0:
            ...
            return $.ajax({
              ...
              success: function success(data) {
                ...
                data.forEach(function (element) {
                  $('#asignatura').append('<option value="' + element.id_asignatura + '">' + element.codigo + ' - ' + element.nombre + '</option>');
                });
              }
            });
...
function loadDisponibilidad() {
  $(document).on('change', '.dia',
  /*#__PURE__*/
  _asyncToGenerator(
  /*#__PURE__*/
  _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee3() {
    var inputHora, hora_inicio, hora_fin;
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            inputHora = $(this).parent().next().next().children('input');
            _context3.next = 4;
            return $.ajax({
              type: 'GET',
              url: '/horarios/dispo/' + $('.periodo').val() + '/' + $('.docente').val() + '/' + $(this).val(),
              success: function success(data) {
...
/***/ 4:
/*!***************************************!*\
  !*** multi ./resources/js/horario.js ***!
  \***************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! C:\xampp\htdocs\ScheduleSoft\scheduleapp\resources\js\horario.js */"./resources/js/horario.js");
