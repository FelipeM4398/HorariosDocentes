...
<div class="form-left-container">
    ...
    <div class="buttons">
        <a href="{{ route('home') }}" class="btn btn-warning text-dark btn-sm">
    ...
    <form class="form-left" method="POST" action="{{ route('login') }}">
        ...
        <div class="form-group">
            ...
            <input id="identificacion" type="number" class="form-control @error('identificacion') is-invalid @enderror"
                placeholder="Ingrese su número de identificación" name="identificacion"
        ...
        <div class="form-group">
            ...
            <input id="password" type="password" placeholder="Ingrese su contraseña" class="form-control"
